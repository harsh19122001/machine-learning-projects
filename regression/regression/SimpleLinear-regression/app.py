# frontend code
# Streamlit app for Salary Prediction using Simple Linear Reggression Model
import streamlit as st
import pickle
import numpy as np

# Load the saved model
model = pickle.load(open(r"D:\python\machine_learning\1.Regression\linear_regression_model.pkl", 'rb'))
